...
//#define REMAP
#ifndef REMAP
#define LCD_BASE    ((uint32_t)(0x60000000 | 0x00000001))
#define LCD         ((LCD_TypeDef *) LCD_BASE)
#endif

#ifdef REMAP
#define LCD_BASE    ((uint32_t)(0xC0000000 | 0x00000001))
#define LCD         ((LCD_TypeDef *) LCD_BASE)
#endif
...
#define INTERFACE						INTERFACE_PROG_FMC
...
#define TFTHEIGHT  						320								//< ������
	...
	volatile uint16_t ScreenBuff[TFTWIDTH * TFTHEIGHT];
...
//
	...
	uint16_t ScreenBuff[TFTWIDTH * TFTHEIGHT];			//not relised
